...
<head>
    ...
    <style>
        ...
        body { background-color: var(--bg-light); font-family: 'Plus Jakarta Sans', -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif; margin: 0; padding: 0; }
        .page-wrapper { display: flex; min-height: 100vh; width: 100%; }

        /* SIDEBAR STYLING (EXACTLY MATCHED TO RESIDENTS) */
        .sidebar {
        ...
        .main-content { flex-grow: 1; padding: 40px; background-color: var(--bg-light); box-sizing: border-box; max-width: calc(100vw - 250px); }
